      ...
      <main className="p-8">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
          <div className="flex items-start justify-between gap-4">
            <div>
              <h1 className="text-xl font-bold text-gray-900">{bill.provider_name || bill.original_filename}</h1>
              {bill.provider_name && <p className="mt-0.5 text-xs text-gray-400">{bill.original_filename}</p>}
